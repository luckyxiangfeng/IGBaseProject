...
- (void)setupScrollLineAndCover {
    ...
    if (self.scrollLine) {
        self.scrollLine.frame = CGRectMake(coverX-10 , self.zj_height - self.segmentStyle.scrollLineHeight, coverW+20 , self.segmentStyle.scrollLineHeight);
...
- (void)adjustUIWhenBtnOnClickWithAnimate:(BOOL)animated {
    ...
    [UIView animateWithDuration:animatedTime animations:^{
        ...
        if (weakSelf.scrollLine) {
            weakSelf.scrollLine.zj_x = currentLabel.zj_x-10;
            weakSelf.scrollLine.zj_width = currentLabel.zj_width+20;
        }
...
- (void)adjustUIWithProgress:(CGFloat)progress oldIndex:(NSInteger)oldIndex currentIndex:(NSInteger)currentIndex {
    ...
    if (self.scrollLine) {
        self.scrollLine.zj_x = oldLabel.zj_x-10 + xDistance * progress;
        self.scrollLine.zj_width = oldLabel.zj_width+20 + wDistance * progress;
    }
